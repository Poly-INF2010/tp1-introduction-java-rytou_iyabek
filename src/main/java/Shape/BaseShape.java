...
//helper function to clone a list of points 
  public Collection<Point2d> cloneCoords(Collection<Point2d> coords) {
    ...
    public Collection<Point2d> cloneCoords() {
        BaseShape clonedShape = new BaseShape();
        for (Point2d elements : this.coords) {
            clonedShape.add(elements);
        }

        return clonedShape.coords;
    }
