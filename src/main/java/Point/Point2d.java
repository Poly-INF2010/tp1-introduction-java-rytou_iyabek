...
public class Point2d extends AbstractPoint {
    ...
    /** TODO
     * 2D Point Constructor from coordinate
    ...
    public Point2d rotate(Double angle) {
        Double[][] rotationAngle = new Double[][] {{Math.cos(angle), -Math.sin(angle)}, {Math.sin(angle), Math.cos(angle)}};
        PointOperator.rotate(this.vector, rotationAngle);
        return this;
    }
